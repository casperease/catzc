<#
.SYNOPSIS
    Computes a globset's durable SHA — the deployable unit's identity (ADR-FLOW-CD-GLOBS:5).
.DESCRIPTION
    ...
    as 64 lowercase hex chars — exactly the marker file's sha256 value (ADR-FLOW-CD-GLOBS:9). A
