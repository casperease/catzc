...
// least one include and no exclude, ADR-GLOBS:4). MarkerPath is the unit's committed sha-marker path
// (.sha-markers/<name>.sha256, ADR-GLOBS:1); no globset may match its own marker file or the config itself
