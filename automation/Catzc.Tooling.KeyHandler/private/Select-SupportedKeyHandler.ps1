...
.DESCRIPTION
    ...
    testable without a real PSReadLine session (see ADR-AUTO-TEST push-left). Given the captured bindings
    ...
    the inputs only; never mutates the cached config objects (ADR-AUTO-CACHE:5).
.PARAMETER Binding
