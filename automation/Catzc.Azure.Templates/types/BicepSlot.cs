// One deployable slot of a template: the unit binding one config file to one (subscription, environment,
// slot) coordinate, which resolves to one resource group. Nested into BicepTemplate.slots — a template
// fans out into one BicepSlot per deployable coordinate.
...
public sealed class BicepSlot
{
    ...
    // The subscription this slot deploys into. Always present.
