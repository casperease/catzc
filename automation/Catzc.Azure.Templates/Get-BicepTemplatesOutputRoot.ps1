...
.DESCRIPTION
    ...
    as a seam (ADR-AUTO-PESTER:2): build tests mock it to a folder of their own so no two test files ever write
    the same build folder (a fixed out/ path two files both write is the serial-tag race, ADR-AUTO-TEST:26 —
