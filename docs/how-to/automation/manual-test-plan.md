...
| 58  | L2   | automation/Catzc.Base.Globs/tests/ShaMarker-Freshness.Tests.ps1                            | Marker freshness                                                     | Every globset's committed `.sha-markers/<name>.yml` matches its recomputed definition + durable SHA — none stale, missing, or orphaned.                                                                        |
